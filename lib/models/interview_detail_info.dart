...
class InterviewDetailInfoInterviewInfoAssetLastMonthTransactionFlow {
  ...
  factory InterviewDetailInfoInterviewInfoAssetLastMonthTransactionFlow.fromJson(Map<String, dynamic> json) =>
      $InterviewDetailInfoInterviewInfoAssetLastMonthTransactionFlowFromJson(json);
...
class InterviewDetailInfoInterviewInfoAssetInvestmentCertificate {
  ...
  factory InterviewDetailInfoInterviewInfoAssetInvestmentCertificate.fromJson(Map<String, dynamic> json) =>
      $InterviewDetailInfoInterviewInfoAssetInvestmentCertificateFromJson(json);
