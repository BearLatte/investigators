...
class JsonConvert {
  ...
  static M? _getListChildType<M>(List<Map<String, dynamic>> data) {
    if (<AddressListItem>[] is M) {
      return data.map<AddressListItem>((Map<String, dynamic> e) => AddressListItem.fromJson(e)).toList() as M;
    }
...
class JsonConvertClassCollection {
  Map<String, JsonConvertFunction> convertFuncMap = {
    (AddressListItem).toString(): AddressListItem.fromJson,
